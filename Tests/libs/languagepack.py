class LanguagePackEN:
	...
	Button['RenewDatabase'] = "Renew Database"
	...
	Label['BrowseType'] = "Browse type:"

	Label['ScanConfig'] = "Scan config:"
	...
	ToolTips['SourceDocumentEmpty'] = "No image is selected"
...
class LanguagePackKR:
	...
	Button['SelectArea'] = "위치 선택"
	Button['AddAreaWithText'] = "입력 위치"
	...
	Label['ImageSource'] = "이미지 출처:"
	Label['MatchType'] = "일치 유형:"
	Label['BrowseType'] = "찾아보기 유형:"

	Label['ScanConfig'] = "스캔 구성:"
	...
	ToolTips['SourceDocumentEmpty'] = "선택한 이미지가 없습니다."
